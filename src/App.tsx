...
const AgentAlertsPage = lazy(() => import('./pages/AgentAlertsPage'));
...
const KnowledgeBaseSetupPage = lazy(() => import('./pages/KnowledgeBaseSetupPage'));
const AgentsDocsPage = lazy(() => import('./pages/AgentsDocsPage'));
                    ...
                    <AuthGuard>
                      ...
                      <AppLayout>
                        <Routes>
                          ...
                          />
                          <Route
                            path="/knowledge-bases/setup"
                            element={
                              <SafePage>
                                <KnowledgeBaseSetupPage />
                              </SafePage>
                            }
                          />
                          <Route
                          ...
                          />
                          <Route
                            path="/knowledge-management/article/:id"
                            element={
                              <SafePage>
                                <ArticleEditorPage />
                              </SafePage>
                          ...
                          <Route
                            ...
                            element={
                              <SafePage>
                                <ProtectedRoute permission="settings.api_keys">
                                  <SecurityPage />
                                </ProtectedRoute>
                              </SafePage>
                            }
                          ...
                          <Route
                            ...
                            element={
                              <SafePage>
                                <ProtectedRoute permission="settings.billing">
                                  <BillingPage />
                                </ProtectedRoute>
                              </SafePage>
                            }
                          ...
                          <Route
                            ...
                            element={
                              <SafePage>
                                <ProtectedRoute permission="agents.deploy">
                                  <ApprovalQueuePage />
                                </ProtectedRoute>
                              </SafePage>
                            }
                          ...
                          />
                          <Route
                            path="/marketplace-pro"
                            element={
                              <SafePage>
                                <MarketplaceMonetizedPage />
                              </SafePage>
                            }
                          />
                          <Route
                          ...
                          />
                          <Route
                            path="/security/secrets-rotation"
                            element={
                              <SafePage>
                                <ProtectedRoute permission="settings.api_keys">
                                  <SecretsRotationPage />
                          ...
                          />
                          <Route
                            path="/observability/cost-anomalies"
                            element={
                              <SafePage>
                                <CostAnomaliesPage />
                              </SafePage>
                          ...
                          />
                          <Route
                            path="/observability/game-days/:id/live"
                            element={
                              <SafePage>
                                <GameDayLivePage />
                              </SafePage>
                          ...
                          />
                          <Route
                            path="/observability/playbooks"
                            element={
                              <SafePage>
                                <IncidentPlaybooksPage />
                              </SafePage>
                            }
                          />
                          <Route
                          ...
                          />
                          <Route
                            path="/observability/postmortems"
                            element={
                              <SafePage>
                                <PostmortemsPage />
                              </SafePage>
                          ...
                          />
                          <Route
                            path="/observability/postmortems/:id"
                            element={
                              <SafePage>
                                <PostmortemEditorPage />
                              </SafePage>
                            }
                          />
                          <Route
                          ...
                          />
                          <Route
                            path="/security/pentest-findings"
                            element={
                              <SafePage>
                                <ProtectedRoute permission="settings.api_keys">
                                  <PentestFindingsPage />
