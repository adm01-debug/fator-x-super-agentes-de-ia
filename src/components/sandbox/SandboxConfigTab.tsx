    ...
    <div className="pt-4 space-y-4">
      ...
      {config.runtime !== 'none' && (
        <div className="space-y-3">
          <span className="text-xs text-muted-foreground font-medium">Limites de Recursos</span>
          <SliderField
            label="CPU"
          ...
          <SliderField
            ...
            step={128}
            unit="MB"
            onChange={(v) => onUpdate({ memoryLimitMb: v })}
          />
          <SliderField
            label="Timeout"
            ...
            step={5}
            unit="seg"
            onChange={(v) => onUpdate({ timeoutSeconds: v })}
          />
          <SliderField
            ...
            step={10}
            unit="MB"
            onChange={(v) => onUpdate({ maxWorkspaceSizeMb: v })}
          />
        </div>
      )}
    </div>
