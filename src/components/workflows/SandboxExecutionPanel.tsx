...
import {
  ...
  type SandboxExecutionPanelProps,
  DEFAULT_CONFIG,
  RUNTIME_OPTIONS,
        ...
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center justify-between text-base text-foreground">
            <span className="flex items-center gap-2">
              ...
              {agentId && (
                <Badge className="bg-primary/20 text-primary text-[10px] ml-1">Agent Config</Badge>
              )}
            </span>
            <Badge
              className="text-[10px]"
              ...
              {config.networkEnabled && (
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateConfig({ allowedDomains: e.target.value.split('\n').filter(Boolean) })
                    }
              ...
              <div className="p-3 rounded-lg bg-background border border-border">
                ...
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={config.networkEnabled ? 'text-nexus-amber' : 'text-nexus-emerald'}
                    >
                      {config.networkEnabled
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={config.shellAccess ? 'text-destructive' : 'text-nexus-emerald'}
                    >
