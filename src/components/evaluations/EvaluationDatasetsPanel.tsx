...
export function EvaluationDatasetsPanel() {
  ...
  const handleCreateTestCase = async () => {
    if (!caseInput.trim() || !selectedDatasetId) {
      toast.error('Input é obrigatório');
      return;
    }
    setSaving(true);
    try {
        ...
        <Dialog open={newDsOpen} onOpenChange={setNewDsOpen}>
          <DialogTrigger asChild>
            <Button variant="outline" size="sm" className="gap-1.5 text-xs">
              <Plus className="h-3 w-3" /> Novo dataset
            </Button>
          </DialogTrigger>
            ...
            <div className="space-y-3 mt-2">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="Ex: Factualidade v1"
                />
              </div>
              <div className="space-y-1">
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Todos os test cases serão removidos.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
          ...
          <div className="lg:col-span-2 space-y-3">
              ...
              {selectedDatasetId && (
                <Dialog open={newCaseOpen} onOpenChange={setNewCaseOpen}>
                  ...
                  <DialogContent className="sm:max-w-[480px]">
                    <DialogHeader>
                      <DialogTitle>Novo Test Case</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-3 mt-2">
                      <div className="space-y-1">
                        ...
                        <Textarea
                          ...
                          className="bg-secondary/50"
                          rows={3}
                          placeholder="Pergunta ou prompt de teste"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <Textarea
                          ...
                          className="bg-secondary/50"
                          rows={3}
                          placeholder="Resposta correta esperada"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="bg-secondary/50"
                          placeholder="factualidade, safety"
                        />
                      </div>
                      <Button
            ...
            {!selectedDatasetId ? (
              <div className="text-center py-12">
                <p className="text-xs text-muted-foreground">Selecione um dataset à esquerda</p>
              </div>
            ) : loadingCases ? (
              <div className="flex justify-center py-8">
                <Loader2 className="h-5 w-5 animate-spin text-muted-foreground" />
              ...
              <div className="text-center py-8">
                ...
                <p className="text-xs text-muted-foreground">
                  Nenhum test case. Adicione casos para avaliar agentes.
                </p>
              </div>
            ) : (
                  ...
                  <div key={tc.id} className="nexus-card p-3 group">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle>Excluir test case?</AlertDialogTitle>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            <AlertDialogCancel>Cancelar</AlertDialogCancel>
                            <AlertDialogAction
                    ...
                    <div className="space-y-1.5">
                      <div>
                        ...
                        <p className="text-xs text-foreground">{tc.input}</p>
                      </div>
                      {tc.expected_output && (
                        <div>
                          <p className="text-[11px] font-semibold text-muted-foreground uppercase">
                          ...
                          <p className="text-xs text-foreground">{tc.expected_output}</p>
                        </div>
                      )}
                    </div>
                  </div>
