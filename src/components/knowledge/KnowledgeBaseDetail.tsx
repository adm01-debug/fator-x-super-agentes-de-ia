...
export function KnowledgeBaseDetail({ kbId, kbName, onBack }: KnowledgeBaseDetailProps) {
  ...
  const { data: documents = [], isLoading: loadingDocs } = useQuery({
    ...
    queryFn: () =>
      selectedCollectionId ? listDocuments(selectedCollectionId) : Promise.resolve([]),
  ...
  const handleCreateDocument = async () => {
    if (!docTitle.trim() || !selectedCollectionId) {
    ...
    try {
      ...
      if (ingestResult) {
        toast.success(
          `${(ingestResult as Record<string, number>)?.chunks_created || 0} chunks criados`,
        );
      }
    ...
    <div className="space-y-4">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
          ...
          {loadingColls ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-xs text-muted-foreground">
                Nenhuma collection. Crie uma para organizar documentos.
              </p>
            </div>
          ) : (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>Excluir collection?</AlertDialogTitle>
                          <AlertDialogDescription>
                            Todos os documentos e chunks serão removidos.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
        ...
        <div className="space-y-3">
              ...
              <Dialog open={newDocOpen} onOpenChange={setNewDocOpen}>
                ...
                <DialogContent className="sm:max-w-[480px]">
                  ...
                  <div className="space-y-3 mt-2">
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs">Conteúdo (opcional — cria chunk automático)</Label>
                      <Textarea
                        value={docContent}
          ...
          {!selectedCollectionId ? (
            <div className="text-center py-8">
              <p className="text-xs text-muted-foreground">Selecione uma collection à esquerda</p>
            </div>
          ) : loadingDocs ? (
            <div className="flex justify-center py-8">
              <Loader2 className="h-5 w-5 animate-spin text-muted-foreground" />
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Chunks associados serão removidos.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
        ...
        <div className="space-y-3">
          ...
          {!selectedCollectionId ? (
            <div className="text-center py-8">
              <p className="text-xs text-muted-foreground">Selecione uma collection</p>
            </div>
          ) : loadingChunks ? (
            <div className="flex justify-center py-8">
              <Loader2 className="h-5 w-5 animate-spin text-muted-foreground" />
