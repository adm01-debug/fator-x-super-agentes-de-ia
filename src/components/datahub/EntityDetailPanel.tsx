...
import { Database, Users, Factory, Truck, Package, UserCheck, MessageCircle, Table2, GitBranch, Link2, ExternalLink, ArrowRight, Eye } from 'lucide-react';
...
export function EntityDetailPanel({ entityId, mapping, onBrowse }: {
  entityId: string; mapping: EntityMapping; onBrowse: (entityId: string) => void;
}) {
  ...
  return (
    <div className="nexus-card space-y-4">
      ...
      {mapping.note && (
        <div className="p-2.5 rounded-lg bg-nexus-amber/10 border border-nexus-amber/20 text-[11px] text-nexus-amber">⚠️ {mapping.note}</div>
      )}
      {mapping.group_by && (
