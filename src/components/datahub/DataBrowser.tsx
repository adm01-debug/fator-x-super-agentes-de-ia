    ...
    <div className="nexus-card space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          <Button
            size="sm"
            className="gap-1.5 text-xs nexus-gradient-bg text-primary-foreground"
          ...
          >
            ...
            Filtros{' '}
            {filters.length > 0 && (
              <Badge variant="default" className="text-[11px] h-4 ml-1">
                {filters.length}
              </Badge>
            )}
          </Button>
      ...
      {!loading && data.length > 0 && (
        <p className="text-[10px] text-muted-foreground flex items-center gap-1">
          <Pencil className="h-3 w-3" /> Duplo clique em uma célula para editar inline · Use
          checkboxes para edição em massa
        </p>
      )}
      ...
      <AlertDialog open={confirmDeleteOpen} onOpenChange={setConfirmDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir {selectedIds.size} registro(s)? Esta ação não pode ser
              desfeita.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
