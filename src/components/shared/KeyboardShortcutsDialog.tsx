...
export function KeyboardShortcutsDialog() {
  ...
  return (
    <>
      ...
      />
      <div
        className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md rounded-xl border border-border bg-background shadow-2xl animate-fade-in-up"
        role="dialog"
      ...
      >
        ...
        <div className="px-5 py-3 border-t border-border/50">
          <p className="text-[11px] text-muted-foreground text-center">
            Pressione{' '}
            <kbd className="inline-flex h-5 items-center rounded border border-border bg-secondary/50 px-1 text-[11px] font-mono">
              ?
            </kbd>{' '}
            para abrir/fechar
          </p>
