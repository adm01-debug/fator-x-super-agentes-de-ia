    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          title:
            'group-[.toast]:font-heading group-[.toast]:font-semibold group-[.toast]:text-sm group-[.toast]:tracking-tight',
          description: 'group-[.toast]:text-muted-foreground group-[.toast]:text-xs',
          actionButton:
            'group-[.toast]:bg-primary group-[.toast]:text-primary-foreground group-[.toast]:rounded-lg group-[.toast]:text-xs group-[.toast]:font-medium group-[.toast]:shadow-md group-[.toast]:shadow-primary/20',
          cancelButton:
